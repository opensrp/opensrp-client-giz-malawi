...
public class ChildFormActivity extends BaseChildFormActivity {
    ...
    public String lookUpQuery(Map<String, String> entityMap, String tableName) {
        ...
        queryBUilder.SelectInitiateMainTable(tableName,
                new String[]{MotherLookUpUtils.RELATIONALID, MotherLookUpUtils.DETAILS, Constants.KEY.ZEIR_ID, Constants.KEY.FIRST_NAME, Constants.KEY.LAST_NAME,
                        AllConstants.ChildRegistrationFields.GENDER, Constants.KEY.DOB, MotherLookUpUtils.NRC_NUMBER, MotherLookUpUtils.CONTACT_PHONE_NUMBER,
