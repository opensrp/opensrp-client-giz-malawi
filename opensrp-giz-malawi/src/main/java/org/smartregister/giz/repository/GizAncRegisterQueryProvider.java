...
public class GizAncRegisterQueryProvider extends RegisterQueryProvider {
    ...
    public String getObjectIdsQuery(String mainCondition, String filters) {
        ...
        return "select ec_client.object_id from ec_client_search ec_client " +
                "join ec_mother_details on ec_client.object_id =  ec_mother_details.id " +
                "join client_register_type on ec_client.object_id=client_register_type.base_entity_id " +
    ...
    public String getCountExecuteQuery(String mainCondition, String filters) {
        ...
        return "select count(ec_client.object_id) from ec_client_search ec_client " +
                "join ec_mother_details on ec_client.object_id =  ec_mother_details.id " +
                "join client_register_type on ec_client.object_id=client_register_type.base_entity_id " +
                "where register_type='anc' " + mainCondition + filters;
    }
